        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <ul>
                    ...
                    <li>Effects can return cleanup functions, which can clean up timers using memory, listeners to outside APIs, and other functions which mayu use system resources.</li>
                </ul>
                <SampleEffect />
                <br />
                <SampleEffect />
...
const SampleEffect = () => {
    ...
    return(
        <div style={{border: '1px dashed black'}}>
            <h2>This component demoes on effect</h2>
            <button onClick={buttonHandler}>Click me to start on effect in the console</button>
        </div>
    )
}