...
Arrow functions are expressional functions that can be simlified into one of the two forms, CONCISE and BLOCK BODY. 
The main gola is to generate shorter syntax for writing a function.
...
/*
    ...
    2. Parameters are still capable of being injected.
        - if we have only one parameter, we technically don't need the parans ()
