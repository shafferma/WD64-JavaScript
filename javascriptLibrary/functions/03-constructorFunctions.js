...
* *********
    - Functions allow us to easisly create a unique solution for different circumstances by using parameters.
...
/*
    ...
    4. The 'this' keyword. 'this' give us the ability to refer back to whatever called, or whatever activates it. In
    ...
    7 & 8: This 'new' keyword is calling our Person function, creating a new person with the values we pass as
    arguments, and storing that person in a variable.
*/
