...
let light = "on"; // off (running that skips and displays nothing)
...
if(name == 'Ashley'){ // == is basically 'is'
...
if(cookTime === 45) {
    ...
    console.log(`It has only been ${cookTime} minutes. Wait another 5 - 15 minutes.`) // easier way to write this script with ``
} else if(cookTime >= 20) {
...
let age = 30; 
if(age >= 17) {
    console.log(` ${age} Sorry, you're too young to do anything.`)
} else if(age >= 18) {
    console.log(` ${age} You can vote!`)
} else if(age >= 21) {
    console.log(` ${age} You can drink!`) 
} else if(age >= 25) {
...
console.log(`${age} too young to do anything.`)
} 
...
// if(myName == 'Ashley'){ // == is basically 'is'
...
// 1                              (2)                                         (3)
 myName === 'Ashley' ? console.log(`Hello, my name is ${myName}.`) : console.log(`Hello, is your name ${myName}?`);
...
// lampOn === 'true' ? console.log(`The lamp is on during the day ${daytime}.`) : console.log(`The lamp is off during the day ${lampOn}`)
...
switch(instructor){
    ...
    default:
        ...
        //Need to use a default to help us catch those cases when none are tru.
}
